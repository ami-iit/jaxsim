...
# from .integrators import Integrator, _INTEGRATORS_MAP
...
class JaxSimModel(JaxsimDataclass):
    ...
    # integrator: Static[js.integrators.Integrator] = dataclasses.field(
    ...
    def build_from_model_description(
        ...
        *,
        ...
        # integrator: js.integrators.Integrator | None = None,
