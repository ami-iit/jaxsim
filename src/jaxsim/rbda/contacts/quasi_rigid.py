...
class QuasiRigidContactsParams(ContactsParams):
    ...
    def __eq__(self, other: QuasiRigidContactsParams) -> bool:
    ...
    ) -> QuasiRigidContactsParams:
        """Create a `QuasiRigidContactsParams` instance"""
    ...
    def build_from_jaxsim_model(
        ...
        *,
        ...
        """Build a `QuasiRigidContactsParams` instance from a `JaxSimModel`."""

        return QuasiRigidContactsParams.build(
...
class QuasiRigidContacts(ContactModel):
    ...
    parameters: QuasiRigidContactsParams = dataclasses.field(
        default_factory=QuasiRigidContactsParams
    )
    ...
    def _regularizers(
        ...
        position: jtp.Array,
        velocity: jtp.Array,
        parameters: QuasiRigidContactsParams,
    ) -> tuple:
        """
        ...
        Args:
            ...
            parameters (QuasiRigidContactsParams): The parameters of the quasi rigid contacts model.
