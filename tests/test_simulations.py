...
def test_simulation_with_soft_contacts(
    ...
    with model.editable(validate=False) as model:
        ...
        model.contacts_params = js.contact.estimate_good_contact_parameters(
            model=model,
...
def test_simulation_with_rigid_contacts(
    ...
    with model.editable(validate=False) as model:
        ...
        model.contacts_params = model.contact_model._parameters_class(K=1e5)
...
def test_simulation_with_relaxed_rigid_contacts(
    ...
    with model.editable(validate=False) as model:
        ...
        model.contacts_params = model.contact_model._parameters_class()
