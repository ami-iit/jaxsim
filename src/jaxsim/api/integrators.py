...
def _integrate_base_velocity(
    base_position: jnp.ndarray,
    base_quaternion: jnp.ndarray,
    base_transform: jnp.ndarray,
    base_linear_velocity_inertial: jnp.ndarray,
    base_ang_velocity_mixed: jnp.ndarray,
    dt: float,
    ...
    new_base_position = base_position + dt * base_linear_velocity_inertial
    new_base_quaternion = base_quaternion + dt * base_quaternion_derivative
    ...
    return new_base_position, new_base_quaternion
...
def semi_implicit_euler_integration(
    ...
    with data.switch_velocity_representation(jaxsim.VelRepr.Inertial):
        ...
        new_base_position, new_base_quaternion = _integrate_base_velocity(
            base_position=data._base_position,
            base_quaternion=data._base_quaternion,
            base_transform=data._base_transform,
            base_linear_velocity_inertial=base_lin_velocity_mixed,
            base_ang_velocity_mixed=base_ang_velocity_mixed,
            dt=dt,
        )

        new_joint_position = data._joint_positions + dt * new_joint_velocities
...
# _INTEGRATORS_MAP: dict[Integrator, Callable[..., js.data.JaxSimModelData]] = {
#     Integrator.SemiImplicitEuler: js.integrators.semi_implicit_euler_integration,
#     Integrator.RungeKutta4: js.integrators.rk4_integration,
# }
